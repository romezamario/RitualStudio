...
- Home editorial con metadata SEO específica, hero visual estilo florería premium, bloque de estudio, rutas visuales hacia Curated Marketplace (`/marketplace`), Experiences (`/cursos`), Design by Brief (`/custom`), Events & Spaces (`/eventos`), Editorial Selection y CTA final hacia contacto (`/contacto`).
