...
- Home editorial con metadata SEO específica y rediseño visual inspirado en una florería contemporánea: hero floral, chips de ocasiones, tarjetas de servicios hacia Marketplace (`/marketplace`), Diseño a medida (`/custom`), Eventos (`/eventos`), bloque de atelier, proceso y CTA final.
