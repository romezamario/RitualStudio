...
- Dashboard de cuenta y administración (`/mi-cuenta`, `/mi-cuenta/perfil`, `/admin/*`), incluyendo acceso visible para actualizar datos de perfil y admin de cursos/sesiones con cupos por sesión y carga directa de imagen de curso (sin URL manual) usando el mismo pipeline/validaciones de imágenes del módulo de productos.
