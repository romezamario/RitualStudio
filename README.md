...
- Home editorial con hero visual y secuencia de secciones: The Studio, Curated Marketplace (`/marketplace`), Experiences (`/cursos`), Design by Brief (`/custom`), Events & Spaces (`/eventos`), Editorial Selection y CTA final hacia contacto (`/contacto`).
