...
- La UI de `/mi-cuenta/perfil` reutiliza `SiteShell` para consistencia visual con vistas de cuenta y concentra los inputs en una tarjeta con grid responsivo de tres columnas (desktop) y una columna (mobile).
