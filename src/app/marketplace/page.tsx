          ...
          {categories.map((category) => {
            ...
            return (
              ...
              >
                ...
                {featuredProduct ? (
                  <article className="studio-card marketplace-featured-card clickable-card">
                    <Link
                ...
                {secondaryProducts.length > 0 ? (
                  <div className="marketplace-secondary-grid">
                    {secondaryProducts.map((product) => (
                      <article key={product.slug} className="studio-card marketplace-card marketplace-secondary-card clickable-card">
                        <Link
